...
data class ShotFormState(
    ...
    val lie: Lie? = null,
    val shotType: ShotType? = ShotType.Full,
    val powerPct: Int = 100,
        ...
        viewModelScope.launch {
            ...
            if (existing != null) {
                _formState.value = ShotFormState(
                    ...
                    powerPct = existing.powerPct ?: 100,
    ...
    fun saveShot(onSaved: () -> Unit) {
        ...
        viewModelScope.launch {
            ...
            val shotData = Shot(
                ...
                powerPct = if (form.powerPct != 100) form.powerPct else null,
